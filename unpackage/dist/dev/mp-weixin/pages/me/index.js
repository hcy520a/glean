...
var _index2 = _interopRequireDefault(__webpack_require__(/*! ./pages/me/index.vue */ 19));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // @ts-ignore
...
/* harmony import */ var _index_vue_vue_type_template_id_373b9194_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=373b9194&scoped=true& */ 20);
...
/* harmony import */ var _index_vue_vue_type_style_index_0_id_373b9194_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&id=373b9194&scoped=true&lang=scss& */ 25);
...
//
//
var prf = 't-';var _default = { data: function data() {return { userInfo: {}, navs: [{ icon: prf + ' t-icon-gerenxinxi1', name: '个人信息' }, { icon: prf + 'icon-guanyuwomen-01-01', name: '关于拾穗' }, { icon: prf + 'icon-fenxiangweiyin1', name: '分享拾穗', open_type: 'share' }, { icon: prf + 'icon-tuichuzhanghao1', name: '清除缓存' }] };}, onLoad: function onLoad() {// this.wxlogin()
  }, methods: { wxlogin: function wxlogin() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (!_this.userInfo.nickName) {_context.next = 2;break;}return _context.abrupt("return");case 2:uni.login({ provider: 'weixin', success: function success(res) {var code = res.code;cloudApi.call({ // 使用封装好的 
                      name: "login", data: { code: code }, success: function success(res) {_this.userInfo = res.result;getApp().globalData.userInfo = _this.userInfo;uni.setStorageSync("userInfo", _this.userInfo);} }); // uniCloud.callFunction({ // 使用封装好的 
                    // 	name: "login",
                    // 	data: {
                    // 		code
                    // 	},
    ...
    updateUserInfo: function updateUserInfo() {var _this2 = this;
      uni.getUserProfile({ // 11月8日将不在提供头像和昵称信息
        ...
        success: function success(res) {
          ...
          getApp().globalData.userInfo = _this2.userInfo;
